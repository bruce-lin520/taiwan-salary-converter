...
import { jobUrl, homeUrl } from "./paths.js";
...
export function renderJobDetail(slug) {
  ...
  if (!job) {
    el.innerHTML =
      '<p class="analysis warn">暂无该职业资料，未来会持续更新。</p>' +
      `<a href="${homeUrl("#rankings")}" class="btn-secondary" data-internal>← 返回排行榜</a>`;
    return;
  }
